...
import '../css/RegisterDefault.css'
...
/* ======= need to be rewritten and class need to be renamed ======= */
...
class RegisterDefault extends Component {
    ...
    handleSubmit(event) {
        ...
        if (
            ...
            this.state.Register_confirm_password
        ) {
            return alert('密碼不一致')
        } else {
            ...
            if (r) {
                ...
                data.append(
                    'ConfirmPassword',
                    this.state.Register_acc_confirm_password
                )
    ...
    render() {
        ...
        return (
            <div id='Register_acc_container'>
                <div
                    id='Register_acc_register_table'
                    className='container-fluid mt-3'
                >
                    <p id='Register_acc_table_title'>
                        Just A Few Steps to Join EE+!
                    </p>
                    <form onSubmit={this.handleSubmit}>
                        ...
                        >
                            ...
                            <div className='form-group row'>
                                <label
                                    id='Register_acc_email_label'
                                    className='col-form-label col-5 col-sm-4 col-md-3 Register_account_label text-center text-lg-left'
                                >
                                    private email
                                </label>
                                <input
                                    id='Register_acc_email'
                                    placeholder='notify you when account is successfully activate'
                                    type='text'
                                    value={this.state.value}
                                    onChange={this.handleInputChange}
                                    className='form-control offset-sm-1 col-7 col-md-8 Register_account_input'
                        ...
                        >
                            ...
                            <div id='Register_acc_FAQ_content'>
                                <ul id='Register_acc_FAQ_list'>
                                    <li>
                                        ID photo should contain your{' '}
                                        <em>full name</em> and{' '}
                                        <em>intact, clear face</em>.
                                    </li>
                                    <li>
                                        ID photo is used to confirm your
