...
const Support = () => {
    return (
        <div
            ...
            class='col-8 offset-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4'
        >
            <div id='Support_up' className='d-flex justify-content-center ml-3'>
                <p id='Support_up_text'>
                    Your support is vital in enabling NTUEE+ to fulfill our
                    mission to chain all the alumnae in the world.
                </p>
            </div>
            <div
                id='Support_down'
