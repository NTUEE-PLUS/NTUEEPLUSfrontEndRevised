...
import {
    ...
    handleInputChange,
    handleWorkChange,
} from '../functions/handleChanges.js'
import { showVisual, handleSubmit } from '../functions/showAndSubmit.js'
import { map } from '../../config/ProfileConfig'
import {
    OccupationTable,
    Header,
    HeadShot,
    ...
    Contact,
    SocialMedia,
} from '../component/ProfileComponents'
import rmOccupation from '../functions/removeOccupation'
...
class Profile extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            userimage: null, //need to be replaced
            imagePreviewUrl: '',
            realname: '',
            nickname: '',
            email: '',
                ...
                <div id='Profile_information' className='container-fluid mb-5'>
                    ...
                    >
                        ...
                        <div id='Profile_more_info'>
                            ...
                            <div
                                id='Profile_occupation_container'
                                className='mt-1'
                            >
                                <OccupationTable
                                    addOcp={(e) => {
